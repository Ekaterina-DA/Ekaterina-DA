...
| [Дашборд финансовых метрик маркетплейса (DataLens)](https://datalens.yandex/9n0jjs1nw3aet) | Автоматизированный мониторинг выручки, выкупа и средней цены с MoM‑расчётами и детализацией по категориям, брендам и SKU. Помогает отслеживать достижение целевых показателей (+5 % к выручке MoM, 95 % выкупа) и управлять ассортиментом маркетплейса. | DataLens |
| [Анализ продуктовых метрик маркетплейса](https://github.com/Ekaterina-DA/project_1) |Проведение комплексного анализа метрик маркетплейса с использованием когортного анализа, фреймворка ICE и определения ключевых показателей для роста прибыли, включая выявление проблем с удержанием клиентов и техническую оптимизацию процессов. | Jupyter Notebook, Pandas, Numpy, Seaborn, Matplotlib |
|[Учебный проект для отработки навыков HTML и CSS](https://github.com/Ekaterina-DA/Ekaterina-DA.github.io])|Цель проекта: развить навыки использования HTML/CSS для кастомизации дашбордов и Handlebars в Apache Superset|HTML, CSS|
